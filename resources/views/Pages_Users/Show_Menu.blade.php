...
@if (Session::has('success_setcart'))
<div class="alert alert-success" role="alert">
            <strong>Successfull {{Session::get('success_setcart')}} {{Session::get('msg_setcart')}}</strong>
        </div>
    @endif
    @if (Session::has('error_setcart'))
<div class="alert alert-danger" role="alert">
            <strong>Error {{Session::get('error_setcart')}}</strong>
        </div>
    @endif
  <div class="row">
